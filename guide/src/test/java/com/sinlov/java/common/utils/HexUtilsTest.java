...
public class HexUtilsTest extends TempTest {
    ...
    public void hexStr2Bytes() {
        ...
        assertNull(HexUtils.hexStr2Bytes(null));
        assertNull(HexUtils.hexStr2Bytes(""));
    }
    ...
    public void hexStringToBytes() {
        ...
        byte[] bytesNull = HexUtils.hexStringToBytes("");
        assertNull(bytesNull);
        assertNull(HexUtils.hexStringToBytes(null));
    }
    ...
    public void bytes2HexStr() {
        ...
        assertNull(HexUtils.bytes2HexStr(null));
        assertNull(HexUtils.bytes2HexStr(new byte[]{}));
        assertEquals("011120", HexUtils.bytes2HexStr(new byte[]{0x01, 0x11, 0x20}));
    }
